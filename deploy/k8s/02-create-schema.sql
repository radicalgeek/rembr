...
CREATE TABLE IF NOT EXISTS tenants (
  ...
  claim_token_hash_algorithm VARCHAR(20),
...
-- Enterprise/UI audit base with MCP event fields and chain columns. The
-- versioned 017/006 migrations remain idempotent for upgrades.
...
CREATE TABLE IF NOT EXISTS tenant_plans (
  ...
  plan VARCHAR(50) NOT NULL CHECK (
    plan IN ('dev', 'free', 'pro', 'team', 'business', 'enterprise')
  ),
